...
=========================================\n""")
        ...
        addr_from = input("From: introduce your wallet address (public key)\n")
        private_key = input("Introduce your private key\n")
        msg = input("Message: data you want to sign and write to the blockchain\n")
        print("=========================================\n\n")
        print("Is everything correct?\n")
        print("From: {0}\nPrivate Key: {1}\nMessage: {2}\n".format(addr_from, private_key, msg))
        response = input("y/n\n")
        if response.lower() == "y":
            send_data(addr_from, private_key, msg)
    elif response == "4":
        check_transactions()
